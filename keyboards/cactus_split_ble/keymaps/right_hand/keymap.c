...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
      ...
      KC_LCTL,   KC_CAPS,   KC_A,    KC_S,    KC_D,    KC_F,    KC_G, \
      KC_LCTL,   KC_LSFT,   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B, \
      KC_LCTL,   KC_LCTL,   ADJUST,  KC_LGUI, KC_LALT, KC_SPC,  KC_SPC \
      ),
