...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * | Esc  | Ctrl | Win  | Alt  |Space |Space |Lower |Raise |Adjust| KANA | Left | Down |  Up  |Right |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = LAYOUT( \
      ...
      KC_ESC,  KC_LCTL, KC_LGUI, KC_LALT, KC_SPC,  KC_SPC,  LOWER,   RAISE,   ADJUST,  KANA,    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
